...
MIDDLEWARE = [
    ...
    'webApp.middleware.RESTMiddleware',
...
DATABASES = {
    'default': {
        ...
        'NAME': os.environ.get('DATABASE_NAME', 'orc_gui'),
        'USER': os.environ.get('DATABASE_USER', 'gui_root'),
...
JWT_AUTH = {
    ...
    'JWT_PAYLOAD_HANDLER': 'webApp.jwt_handlers.jwt_payload_handler',  # Custom
    ...
    # 'JWT_RESPONSE_PAYLOAD_HANDLER': 'webApp.jwt_handlers.jwt_response_payload_handler',  # Custom
