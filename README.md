...
<p>Statement of Purpose for this OASIS TC Open Repository (openc2-iacd) as <a href="https://drive.google.com/open?id=0B-FunCZrr-vtdEJJQWZJM0dqWGM">proposed</a> and <a href="https://www.oasis-open.org/committees/ballot.php?id=3115">approved</a> [<a href="https://issues.oasis-open.org/browse/TCADMIN-2757">bis</a>] by the TC:</p>
...
<p>The initial codebase is imported from the National Security Agency's Github repository, facilitated by Dave Kemp.</p>

<p>Note: the GitHub repository name was changed to "openc2-iacd" per email message and consensus process <a href="https://lists.oasis-open.org/archives/openc2/201708/msg00058.html">documented</a> in the TC discussion list archives.</p>
...
<p>For Orchestrator Documentation, see <a href="docs/Orchestrator.md">Docs</a></p>